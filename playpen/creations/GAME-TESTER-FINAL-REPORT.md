...
**Usage**:
```scheme
(load "playpen/creations/winter-wonderland.ss")
(winter-wonderland)
```
...
**Usage**:
```scheme
(load "playpen/creations/dice-games.ss")
...
**Usage**:
```scheme
(load "playpen/creations/continuation-quest.ss")
...
**Usage**:
```scheme
(load "playpen/creations/state-dungeon.ss")
```
...
3. **Create new ones** - Add to `playpen/creations/`
