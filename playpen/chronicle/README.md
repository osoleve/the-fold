...
```scheme
(load "playpen/chronicle/tagless-chronicle.ss")
...
```bash
scheme --script playpen/chronicle/test-tagless-chronicle.ss
```

Or create a playtest:

```bash
scheme --script playpen/chronicle/playtest-chronicle.ss
```
...
- **Tagless Final** pattern (`fabric/stitches/dsl/tagless.ss`)
- Original **Chronicle DSL** (`playpen/chronicle-original/`)
