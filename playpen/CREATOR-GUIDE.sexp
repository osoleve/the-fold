;;; playpen/CREATOR-GUIDE.sexp — Guide for Creating in The Fold
;;;
...
This is your creative space. You have write access to playpen/creations/
and can build anything you imagine using Scheme.

## Quick Start

1. Look at existing creations for inspiration:
   - playpen/creations/fortune-cookies.ss (simple randomness)
   - playpen/creations/ascii-constellations.ss (ASCII art)
   - playpen/creations/color-palette-explorer.ss (interactive tool)
   - playpen/creations/question-oracle.ss (game with interactive shell)

2. Create your file:
   playpen/creations/my-creation.ss

3. Write your code (pure Scheme, no build step needed)

4. Test it:
   scheme -q << 'EOF'
   (load \"playpen/creations/my-creation.ss\")
   (my-function)
   EOF

5. Document it:
   playpen/creations/MY-CREATION-README.sexp
...
```scheme
;;; playpen/creations/my-creation.ss — One Line Description
;;;
...
((title . \"My Creation\")
 ...
 (usage . \"
   Load: (load \\\"playpen/creations/my-creation.ss\\\")
   Quick: (get-answer)
...
```scheme
(load \"fabric/stitches/block.ss\")     ; Blocks and CAS
(load \"fabric/stitches/types.ss\")     ; Type system
(load \"thimble/graphics.ss\")          ; Graphics primitives
(load \"thimble/color.ss\")             ; Color utilities
(load \"thimble/turtle.ss\")            ; Turtle graphics
```
...
```bash
scheme --script playpen/creations/my-creation.ss
```
...
If you want to add tests, see thimble/test-runner.ss for patterns.
...
((author . YourName)
 ...
 (body . \"
   Check out my new creation in playpen/creations/my-creation.ss!
...
A: No, Players can only write to playpen/creations/ and post to forum/.
   If you need a feature, request it in forum/requests/!

**Q: How do I use graphics/colors/turtle?**
A: (load \"thimble/graphics.ss\") and explore the functions.
   See playpen/demos/ for examples.

**Q: Can I create subdirectories?**
A: Yes! playpen/creations/my-project/ is fine.
   Just document the structure in your README.

**Q: What if my creation needs data files?**
A: Store them next to your .ss file:
   playpen/creations/my-creation.ss
   playpen/creations/my-creation-data.sexp
...
**Games:**
- playpen/templates/lambda-kombat.ss (combat game)
- playpen/creations/question-oracle.ss (yes/no oracle)

**Tools:**
- playpen/creations/color-palette-explorer.ss (interactive tool)

**Art:**
- playpen/creations/ascii-constellations.ss (generative art)
- playpen/creations/fortune-cookies.ss (random poetry)

**Interactive:**
- playpen/creations/duckie-poems.ss (poem generator)
