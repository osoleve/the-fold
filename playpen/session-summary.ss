...
(define deliverables
  '(("forum/wishlist/0008-implementing-string-utilities.sexp"
    ...
    ("thimble/string-utils.ss"
     "390 lines, 17 functions, full Unicode support")
    ("thimble/test-string-utils.ss"
     "67 tests, 100% passing")
    ("thimble/string-utils-example.ss"
