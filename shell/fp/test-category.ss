;;; shell/fp/test-category.ss — Tests for Validated Category Entry Points
;;;
;;; Tests the shell-layer validation wrappers in shell/fp/category.ss.
;;; These wrappers validate inputs before calling pure lattice functions.
;;;
;;; Run: scheme --script shell/fp/test-category.ss

(load "shell/fp/category.ss")
