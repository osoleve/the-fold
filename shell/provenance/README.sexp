...
blocks it describes.")
  ...
  (related
   ...
   (shell/history "Similar CAS-based audit trail pattern")
   (shell/storage/identity "Agent identity integration")))
