;;; shell/prelude/numeric.ss — Global Numeric Dispatch for Shell/User
;;;
...
;;;
;;; Load this in shell/user sessions to get:
...
;;;
;;; WARNING: This mutates the top-level environment. Only use in shell/user.
...
(define (numeric-prelude-info)
  (display "shell/prelude/numeric.ss loaded.\n")
