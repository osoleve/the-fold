;;; shell/tools/test-rewrite-repl.ss — Tests for Rewrite REPL Commands
;;;
;;; Run from project root: scheme --script shell/tools/test-rewrite-repl.ss

(load "shell/tools/rewrite-repl.ss")
