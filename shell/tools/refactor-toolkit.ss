;;; shell/tools/refactor-toolkit.ss — Unified Refactoring Toolkit
;;;
...
;;;
;;; Dependencies:
;;;   shell/tools/refactor-integrated.ss
;;;   shell/tools/refactor-move.ss
;;;   shell/tools/dead-code.ss
;;;   lattice/meta/dag.ss
...
;;; Module file mapping
(define *module-files*
  '((refactor-integrated . "shell/tools/refactor-integrated.ss")
    (refactor-move . "shell/tools/refactor-move.ss")
    (dead-code . "shell/tools/dead-code.ss")
    (dag . "lattice/meta/dag.ss")
    (call-graph . "shell/lens/call-graph.ss")))
...
(define (refactor-extract-handler name expr file)
  ...
  (display "  Use (load \"shell/tools/refactor-integrated.ss\") directly.\n\n"))
