;;; shell/reactive/README.sexp — Reactive Derivations from Optic Dependencies
;;;
...
when invalidated. This avoids unnecessary work.")))
  ...
  (dependencies
   ((shell/provenance/traced-optics "Optic registry and traced operations")
...
inter-derivation dependencies.")))
  ...
  (related
   (shell/provenance "Provenance tracking (similar audit trail pattern)")
