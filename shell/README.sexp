...
")
 ...
 (for-players . "
Players cannot modify shell/ but can use its functions.
...
")
 (for-builders . "
Builders may modify shell/ to add utilities and tools.

How to add a new utility:

1. Create: shell/my-utility.ss
   ;;; shell/my-utility.ss — One-line description
   ;;;
   ;;; Dependencies:
   ;;;   - core/block.ss
   ;;;   - shell/fs.ss
...
3. Register command (optional): Edit shell/commands.ss
   (register-command! 'my-cmd \"description\" my-function)

4. Test: shell/test-my-utility.ss

5. Document: Add to shell/COMMANDS.md if it's user-facing

See shell/COMMANDS.md for detailed command patterns.
")
 (for-shepherds . "
Shepherds maintain shell/ architecture.
...
See shell/fs.ss for the canonical example.
")
 (see-also . (
   "shell/COMMANDS.md"
   "shell/run-tests.ss"
