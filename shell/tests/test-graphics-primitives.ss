;;; shell/tests/test-graphics-primitives.ss — Tests for graphics-primitives.ss
;;;
;;; Tests for advanced graphics primitives: lines, circles, gradients, polygons.
;;;
;;; NOTE: Run from project root: scheme --script shell/tests/test-graphics-primitives.ss
