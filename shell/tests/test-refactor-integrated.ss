;;; shell/tests/test-refactor-integrated.ss -- Tests for Integrated Refactoring Engine

;;; NOTE: Run from project root:
;;;   scheme --script shell/tests/test-refactor-integrated.ss

(load "core/base/prelude.ss")
(load "core/test-framework.ss")
(load "shell/tools/refactor-integrated.ss")
