;;; shell/tests/test-module-deps.ss -- Tests for Module Dependency Analyzer

;;; NOTE: Run from project root:
;;;   scheme --script shell/tests/test-module-deps.ss

(load "core/base/prelude.ss")
(load "core/test-framework.ss")
(load "shell/tools/module-deps.ss")
...
(test-group path-normalization-tests
            (define-test path-directory-simple-test
              (assert-equal "shell" (path-directory "shell/repl.ss")))
            ...
            (define-test normalize-path-relative-test
              (let ([result (normalize-path "shell/repl.ss" "fs.ss")])
                   (assert-equal "shell/fs.ss" result)))
            
            (define-test normalize-path-absolute-test
              (let ([result (normalize-path "shell/repl.ss" "/abs/path.ss")])
