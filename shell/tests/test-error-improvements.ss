;;; shell/tests/test-error-improvements.ss — Tests for Error Improvements
;;;
;;; Comprehensive test suite for shell/error-improvements.ss
;;; Validates enhanced error context detection, suggestion generation,
;;; and documentation linking.

(load "shell/error-improvements.ss")
