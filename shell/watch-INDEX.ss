...
;;;     - See also
;;;   Load with:
;;;     (load "shell/watch-README.ss")  ; Read as documentation
;;;   Notes:
...
;;;     - Troubleshooting
;;;   Load with:
;;;     (load "shell/watch-quickstart.ss")
;;;   Notes:
...
;;;     - Conclusion
;;;   Load with:
;;;     (load "shell/watch-SUMMARY.ss")  ; Read as documentation
;;;   Notes:
;;;     - High-level overview
...
;;;   - (load "shell/watch-quickstart.ss") for quick start
;;;   - (load "shell/watch-README.ss") for full documentation
;;;
;;; For examples:
;;;   - (load "shell/watch-example.ss")
;;;   - (watch-examples-help)
