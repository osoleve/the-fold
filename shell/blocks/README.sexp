;;; shell/blocks/README.sexp — Block Navigation and Query Modules
;;;
...
")
 ...
 (dependencies
  (internal . (core/blocks/block.ss
               core/blocks/cas.ss
               shell/storage/store-api.ss)))

 (usage . "
Navigate blocks interactively:
  (load \"shell/blocks/block-navigator.ss\")
  (explore-blocks)

Query blocks:
  (load \"shell/blocks/block-query.ss\")
