;;; shell/flashmob/dogfood-run.ss — Dogfood test of flashmob on itself
;;;
;;; Run with: scheme --script shell/flashmob/dogfood-run.ss
...
(flashmob-start '("shell/flashmob/flashmob.ss"
                  "shell/flashmob/triage-game.ss"
                  "shell/flashmob/triage-simple.ss"
                  "shell/flashmob/report.ss"
                  "shell/flashmob/agents.ss"))
