...
pub const PRIMITIVE_NAMES: &[&str] = &[
    ...
    "abs", "neg", "sqrt", "expt", "pow",
    "floor", "ceiling", "round", "truncate",
    "sin", "cos", "tan", "asin", "acos", "atan",
    "log", "exp", "min", "max", "gcd", "lcm",
    "clamp", "between?", "sign", "divmod",
    "int->float", "float->int", "inc", "dec", "succ", "pred",
    // Comparisons
    "<", ">", "<=", ">=", "=",
    "eq?", "equal?", "eqv?",
    // Boolean
    "not", "and", "or",
    // Type predicates
    "null?", "pair?", "list?", "number?", "integer?", "float?",
    "string?", "symbol?", "boolean?", "procedure?", "char?", "vector?",
    "positive?", "negative?", "zero?", "even?", "odd?",
    // List primitives
    "car", "cdr", "cons", "list", "length", "append", "reverse",
    "first", "second", "third", "rest",
    "list-ref", "list-tail", "make-list",
    ...
    "substring", "string-split", "string-join", "string-trim",
    "string-upcase", "string-downcase", "string-contains?",
    "string-empty?", "make-string", "string",
