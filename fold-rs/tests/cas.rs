use fold_rs::fabric::{
    ADDRESS_SIZE, ADDRESS_VERSION, Address, Block, Store, Symbol, address_to_hex, hash_block,
    hex_to_address,
};
...
fn cas_store_and_fetch() {
    ...
    let block = Block::new(Symbol::intern("test"), b"hello".to_vec(), Vec::new());
...
fn cas_hash_stability() {
    ...
    let other = Block::new(Symbol::intern("test"), b"world".to_vec(), Vec::new());
