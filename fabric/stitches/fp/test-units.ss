;;; fabric/stitches/fp/test-units.ss — Tests for Units of Measure
;;;
;;; NOTE: Run from project root: scheme --script fabric/stitches/fp/test-units.ss

(load "fabric/stitches/test-framework.ss")
(load "fabric/stitches/fp/units.ss")
...
(test-group si-prefixes
            ...
            (define-test prefixed-units-test
              ...
              ;; 1 g = 1e-3 kg (but gram uses milli of kg which is micro)
              ;; Actually: gram = kilogram * milli = kg * 1e-3
