...
- `fabric/stitches/types.ss` - Current type system
- `fabric/stitches/kinds.ss` - Kind system with HKT support
- `fabric/stitches/infer.ss` - Type inference
- `fabric/stitches/differentiable.ss` - Differentiable type class (runtime)
- `fabric/stitches/comp-graph.ss` - Computational graph
