;;; fabric/stitches/differentiable.ss — Differentiable Type Class
;;;
...
;;;   - kinds.ss
;;;   - resolve.ss
;;;   - comp-graph.ss (for dual numbers)
;;;   - reverse-diff.ss (for traced values)

(load "fabric/stitches/prelude.ss")
(load "fabric/stitches/kinds.ss")
(load "fabric/stitches/infer.ss")     ; For unify, needed by resolve
...
(define TC-Differentiable
  (make-typeclass
   ...
   K*
   '()  ; No superclasses
   '((lift    . (∀ (d) (=> (Differentiable d) (-> Real d))))
     (primal  . (∀ (d) (=> (Differentiable d) (-> d Real))))
     (tangent . (∀ (d) (=> (Differentiable d) (-> d Real))))
     (d+      . (∀ (d) (=> (Differentiable d) (-> d d d))))
     (d*      . (∀ (d) (=> (Differentiable d) (-> d d d))))
     (d-      . (∀ (d) (=> (Differentiable d) (-> d d d))))
     (d/      . (∀ (d) (=> (Differentiable d) (-> d d d))))
     (d-neg   . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-sq    . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-sqrt  . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-exp   . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-log   . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-sin   . (∀ (d) (=> (Differentiable d) (-> d d))))
     (d-cos   . (∀ (d) (=> (Differentiable d) (-> d d)))))))
...
;;; d-chain : Instance × (d → d) × (d → d) → (d → d)
;;; Chain two differentiable functions: (f ∘ g).
...
;;; get-diff-method : Type × Symbol → Procedure | #f
...
;;; derivative-at : (Differentiable d) => (d → d) × Real → Real
