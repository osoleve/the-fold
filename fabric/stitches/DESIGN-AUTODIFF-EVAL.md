...
- `fabric/stitches/eval.ss` - Fuel-based evaluator
- `fabric/stitches/reverse-diff.ss` - Reverse-mode AD implementation
- `fabric/stitches/prim.ss` - Pure primitive operations
- `fabric/stitches/comp-graph.ss` - Computational graph (forward mode)
- `fabric/stitches/DESIGN-DIFF-TYPES.md` - Type-level differentiation (future)
- `fabric/stitches/test-reverse-diff.ss` - Existing AD tests
