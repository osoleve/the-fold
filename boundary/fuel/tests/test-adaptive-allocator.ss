;;; boundary/fuel/tests/test-adaptive-allocator.ss — Integration Tests for Adaptive Fuel Allocation
;;;
;;; Run from project root: scheme --script boundary/fuel/tests/test-adaptive-allocator.ss

(load "core/testing/test-framework.ss")
(load "boundary/fuel/adaptive-hof.ss")
