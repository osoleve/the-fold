...
;;; This creates:
;;;   boundary/string-helpers.ss
;;;   boundary/test-string-helpers.ss
;;;
;;; Next steps:
;;;   1. Edit boundary/string-helpers.ss to add your functions
...
;;; This creates:
;;;   boundary/complexity-analyzer.ss
;;;   boundary/test-complexity-analyzer.ss
;;;
;;; After generation:
;;;   1. Implement the analysis logic
;;;   2. Add to boundary/toolkit.ss registry:
;;;      (complexity-analyzer analysis "Analyze complexity" "complexity-analyzer.ss")
;;;   3. Test with: scheme --script boundary/test-complexity-analyzer.ss
...
(define (example-6-test-suite)
  (scaffold 'test-suite "my-module-tests"
            '((description . "Tests for my-module")
              (target-file . "boundary/my-module.ss")
...
;;;   boundary/json-utils.ss + test-json-utils.ss
;;;   boundary/xml-utils.ss + test-xml-utils.ss
;;;   boundary/csv-utils.ss + test-csv-utils.ss
...
(define (post-scaffold-checklist module-type)
  ...
  (case module-type
        [(shell-module)
         (display "1. [ ] Implement functions in boundary/<name>.ss\n")
        ...
        [(tool)
         (display "1. [ ] Implement tool logic in boundary/<name>.ss\n")
         (display "2. [ ] Add to boundary/toolkit.ss registry\n")
         (display "3. [ ] Add tests in boundary/test-<name>.ss\n")
         (display "4. [ ] Run tests: scheme --script boundary/test-<name>.ss\n")
         (display "5. [ ] Test in REPL: (load \"boundary/toolkit.ss\") then use tool\n")
