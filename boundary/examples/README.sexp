((name "examples")
 ...
 (usage
  "Load examples in REPL:
     (load \"boundary/examples/demo-turtle.ss\")
     (load \"boundary/examples/graphics-primitives-demo.ss\")

   Execute directly:
     scheme --script boundary/examples/string-utils-example.ss
 ...
 (for-builders
  "Examples are ideal references when building new features:
   ...
   - Understand boundary/core boundaries")
 (for-players
