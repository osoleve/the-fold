...
**Location:** `boundary/tools/string-utils.ss`
...
See:
- `boundary/string-utils-example.ss` - 8 practical examples
- `user/string-art.ss` - Stress tests and creative uses
- `user/string-puzzle.ss` - Word games and puzzles

## Tests

```bash
scheme --script boundary/test-string-utils.ss
```
...
- `core/error.ss`
- `boundary/concept-map.ss`
- `boundary/tools/format.ss`
- `boundary/history.ss`
- `boundary/tools/coverage.ss`
- ...and 18+ more files
