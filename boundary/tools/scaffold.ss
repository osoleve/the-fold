...
;;; Boundary Module Template
(define-template
  'boundary-module
  "Complete boundary module with tests and documentation"
  '((description . ("Module description" . "A new boundary module"))
    (dependencies . ("Dependencies (comma-separated)" . "fs.ss, text.ss")))
  '(((path . "boundary/{{NAME}}.ss")
     (content . ";;; boundary/{{NAME}}.ss — {{DESCRIPTION}}
;;;
;;; This is Boundary code: impure, defensive, handles failure.
;;;
;;; Dependencies:
;;;   {{DEPENDENCIES}}
;;;
...
"))
    ((path . "boundary/test-{{NAME}}.ss")
     (content . ";;; Test harness for boundary/{{NAME}}.ss
;;;
;;; Usage:
;;;   scheme --script boundary/test-{{NAME}}.ss
...
;;;   - No defensive code (Boundary validates input)
...
;;;
;;; This is Boundary code: coordinates analysis and presents results.
;;;
;;; Usage:
;;;   (load \"boundary/{{NAME}}.ss\")
;;;   ({{NAME}}-help)
...
(define (scaffold-help)
  ...
  (display "\n")
  (display "EXAMPLES:\n")
  (display "  ; Create a boundary module\n")
  (display "  (scaffold 'boundary-module \"my-module\"\n")
