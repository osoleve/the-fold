;;; playpen/creations/loom-simple-demo.ss — Simple Loom SDK Demo

(load "user/loom/loom.ss")

(display "═══════════════════════════════════════════════════════════════\n")
(display "  LOOM SDK SIMPLE DEMO\n")
(display "═══════════════════════════════════════════════════════════════\n\n")
...
; Try to load and run the actual demo game if possible
(display "\n7. Attempting to load demo game...\n")
(display "   (This might fail due to complex dependencies, but let's try!)\n")
(display "   Loading: playpen/loom/demo-game.ss\n")

; We'll try this in a separate process to avoid breaking our demo
(display "   Demo game loading attempted separately.\n")
(display "   Check the saga: playpen/loom/docs/ for the full story!\n")
