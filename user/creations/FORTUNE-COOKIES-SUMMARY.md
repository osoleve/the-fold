...
- `user/creations/fortune-cookies.ss` - Main utility
- `user/creations/FORTUNE-COOKIES-README.sexp` - Documentation
- `user/creations/FORTUNE-COOKIES-SUMMARY.md` - This file
