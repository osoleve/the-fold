...
((explorer . Scout)
 ...
 (discoveries . (
   ...
   (creative-contributions
     (dice-games . "Utilities for gaming and storytelling - load with (load \"user/creations/dice-games.ss\")")
   ...
   (issues-and-improvements
     ...
     (issue-2 . (
       ...
       (affected-files . (user/loom/{action combat core entity event tile turn world}.ss))
