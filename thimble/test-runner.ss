...
;;;
;;; Command Line:
;;;   scheme --script shell/test-runner.ss              Run all tests
;;;   scheme --script shell/test-runner.ss core         Run core/ tests only
;;;   scheme --script shell/test-runner.ss shell        Run shell/ tests only
;;;   scheme --script shell/test-runner.ss --pattern <text>
;;;                                                     Filter tests by pattern
;;;   scheme --script shell/test-runner.ss --list       List available tests
;;;   scheme --script shell/test-runner.ss --help       Show help message
;;;
;;; From REPL (interactive):
;;;   (load "thimble/test-runner.ss")
...
(define (run-all-tests-impl)
  ...
  (run-test-category "SHELL TESTS" "shell" *shell-test-files*)
...
(define (print-help)
  ...
  (display "\n")
  (display "Usage:\n")
  (display "  scheme --script shell/test-runner.ss [OPTIONS]\n")
  (display "\n")
  (display "Options:\n")
  ...
  (display "\n")
  (display "From REPL:\n")
  (display "  (load \"shell/test-runner.ss\")\n")
