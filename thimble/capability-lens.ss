...
;;;
;;; Usage:
;;;   (load "thimble/capability-lens.ss")
;;;   (capability-report (fs) "thimble" "forum")
;;;   (capability-scan (fs) "thimble")   ; returns structured data
...
(define (capability-scan fs . paths)
  (let* ([roots (if (null? paths) (list "thimble") paths)]
