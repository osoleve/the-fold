...
(test-group main-api
            ...
            (define-test docgen-file-on-real-file
              ...
              (let ([doc (docgen-file "fabric/stitches/prelude.ss")])
...
(test-group integration
            ...
            (define-test full-pipeline-on-interval
              ...
              (let* ([doc (docgen-file "fabric/stitches/fp/interval.ss")]
            ...
            (define-test full-pipeline-on-numeric
              ...
              (let* ([doc (docgen-file "fabric/stitches/fp/numeric.ss")]
                     [exports (cdr (assq 'exports doc))])
