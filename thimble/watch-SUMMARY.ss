...
;;; Quick start:
;;;   1. Load: (load "thimble/watch.ss")
;;;   2. Use: (auto-reload "your-module.ss")
;;;   3. Or: (load "thimble/watch-daemon-integration.ss")
;;;          (dev-mode-on)

;;; For more information:
;;;   (load "thimble/watch-README.ss")      ; Full documentation
;;;   (load "thimble/watch-quickstart.ss")  ; Getting started
;;;   (load "thimble/watch-example.ss")     ; Examples
