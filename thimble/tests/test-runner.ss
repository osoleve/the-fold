...
;;;   (run-test-file "fabric/stitches/test-block.ss")  Run single file
...
(define (print-help)
  ...
  (display "\n")
  (display "From REPL:\n")
  (display "  (load \"thimble/tests/test-runner.ss\")\n")
  ...
  (display "  (run-test-file \"fabric/stitches/test-block.ss\")  ; single file\n")
