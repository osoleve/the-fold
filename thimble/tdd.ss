...
(define (discover-core-tests)
  ...
  '("fabric/stitches/test-block.ss"
    "fabric/stitches/test-cas.ss"
    "fabric/stitches/test-compile.ss"
    "fabric/stitches/test-eval.ss"
    "fabric/stitches/test-parse.ss"
    "fabric/stitches/test-prim.ss"
    "fabric/stitches/test-resolve.ss"))
...
(define (discover-thimble-tests)
  ...
  '("thimble/tests/test-commands.ss"
    "thimble/tests/test-scaffold.ss"
    "thimble/tests/test-store-api.ss"))
