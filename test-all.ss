...
(define lattice-tests
  '(;; === Tier 0: Foundational ===
    ...
    "linalg/test-svd.ss"
    "linalg/test-svd-properties.ss"
    "linalg/test-quaternion.ss"
    "linalg/test-quaternion-properties.ss"
    "linalg/test-iteration.ss"
    "linalg/test-iteration-properties.ss"
    "linalg/test-iterative-solvers.ss"
    "linalg/test-iterative-solvers-properties.ss"
    "linalg/test-integer-matrix.ss"
    "linalg/test-integer-matrix-properties.ss"
    "linalg/test-graph-laplacian.ss"
    "linalg/test-graph-laplacian-properties.ss"
    "linalg/test-dep-linalg.ss"
    "linalg/test-dep-linalg-properties.ss"
    "linalg/test-numeric-instances.ss"
    "linalg/test-numeric-instances-properties.ss"
    "linalg/test-matrix-blocked.ss"
    "linalg/test-matrix-blocked-properties.ss"
    ;; Data Structures
    "data/test-data-structures.ss"
    "data/test-data-structures-properties.ss"
    "data/test-alist-properties.ss"
    "data/test-heap.ss"
    "data/test-avl-tree.ss"
    "data/test-kdtree.ss"
    "data/test-kdtree-properties.ss"
    "data/test-quadtree.ss"
    "data/test-quadtree-properties.ss"
    "data/test-sort.ss"
    "data/test-sort-properties.ss"
    "data/test-avl-properties.ss"
    "data/test-heap-properties.ss"
    "data/test-hamt.ss"
    "data/test-hamt-properties.ss"
    "data/test-chase-lev-deque.ss"
    "data/test-chase-lev-deque-properties.ss"
    "data/test-collection-protocol.ss"
    "data/test-collection-protocol-properties.ss"
    "data/test-collection-utils.ss"
    "data/test-collection-utils-properties.ss"
    ...
    "data/test-community-homology-properties.ss"
    ;; Algebra
    "algebra/test-polynomial.ss"
    "algebra/test-polynomial-properties.ss"
    "algebra/test-ring-field.ss"
    "algebra/test-ring-field-properties.ss"
    "algebra/test-multivariate-groebner.ss"
    "algebra/test-multivariate-groebner-properties.ss"
    "algebra/test-galois.ss"
    "algebra/test-galois-properties.ss"
    "algebra/test-field-ext.ss"
    "algebra/test-field-ext-properties.ss"
    "algebra/test-module.ss"
    "algebra/test-module-properties.ss"
    "algebra/test-group.ss"
    "algebra/test-group-properties.ss"
    "algebra/test-poly-bridge.ss"
    "algebra/test-poly-bridge-properties.ss"
    "algebra/test-tropical-properties.ss"
    ...
    "random/test-random-properties.ss"
    "random/test-monte-carlo.ss"
    "random/test-monte-carlo-properties.ss"
    "random/test-bayesian.ss"
    "random/test-bayesian-properties.ss"
    ;; QuickCheck
    ...
    ;; FP Core
    "fp/test-markov.ss"
    "fp/test-markov-properties.ss"
    "fp/test-protocol.ss"
    "fp/test-protocol-properties.ss"
    "fp/test-protocol-bundle.ss"
    "fp/test-protocol-bundle-properties.ss"
    "fp/test-protocol-introspect.ss"
    "fp/test-protocol-introspect-properties.ss"
    "fp/test-templates.ss"
    "fp/test-templates-properties.ss"
    "optics/test-optics.ss"
    "optics/test-optics-laws.ss"
    "optics/test-bidirectional.ss"
    "optics/test-bidirectional-properties.ss"
    "optics/test-block-optics.ss"
    "optics/test-block-optics-properties.ss"
    "optics/test-profunctor-optics.ss"
    "optics/test-profunctor-optics-properties.ss"
    "category/test-comonad.ss"
    "category/test-natural-transform.ss"
    "category/test-common-monads.ss"
    "category/test-adjunction.ss"
    "category/test-kleisli.ss"
    "category/test-limits.ss"
    "category/test-free-algebra.ss"
    "category/test-kan-extension.ss"
    "category/test-effect-category.ss"
    "category/test-abstract-interp.ss"
    "category/test-monad-derivation.ss"
    "category/test-state-store-adjunction.ss"
    "category/test-logic-adjunction.ss"
    "category/multi/test-multi-category.ss"
    "fp/clp/test-clp.ss"
    ...
    "symbolic/test-expr.ss"
    "symbolic/test-diff.ss"
    "symbolic/test-simplify.ss"
    "symbolic/test-integrate.ss"
    "symbolic/test-solve.ss"
    "symbolic/test-poly-canonical.ss"
    "rewrite/test-rewrite.ss"
    "rewrite/test-sexp-zipper.ss"
    "rewrite/test-proof-tactics.ss"
    "rewrite/test-sketch.ss"
