...
| Boundary |3| Boundary |.| Boundary | | Boundary |*| Boundary |*| Boundary |�| Boundary |�| Boundary |-| Boundary |e| Boundary |q| Boundary |u| Boundary |i| Boundary |v| Boundary |a| Boundary |l| Boundary |e| Boundary |n| Boundary |c| Boundary |e| Boundary | | Boundary |v| Boundary |i| Boundary |o| Boundary |l| Boundary |a| Boundary |t| Boundary |i| Boundary |o| Boundary |n| Boundary |*| Boundary |*| Boundary |:| Boundary | | Boundary |`| Boundary |(| Boundary |�| Boundary |�| Boundary | | Boundary |x| Boundary |.| Boundary | | Boundary |x| Boundary |)| Boundary |`| Boundary | | Boundary |a| Boundary |n| Boundary |d| Boundary | | Boundary |`| Boundary |(| Boundary |�| Boundary |�| Boundary | | Boundary |y| Boundary |.| Boundary | | Boundary |y| Boundary |)| Boundary |`| Boundary | | Boundary |a| Boundary |r| Boundary |e| Boundary | | Boundary |s| Boundary |t| Boundary |o| Boundary |r| Boundary |e| Boundary |d| Boundary | | Boundary |d| Boundary |i| Boundary |f| Boundary |f| Boundary |e| Boundary |r| Boundary |e| Boundary |n| Boundary |t| Boundary |l| Boundary |y| Boundary | | Boundary |d| Boundary |e| Boundary |s| Boundary |p| Boundary |i| Boundary |t| Boundary |e| Boundary | | Boundary |i| Boundary |d| Boundary |e| Boundary |n| Boundary |t| Boundary |i| Boundary |c| Boundary |a| Boundary |l| Boundary | | Boundary |s| Boundary |e| Boundary |m| Boundary |a| Boundary |n| Boundary |t| Boundary |i| Boundary |c| Boundary |s| Boundary |
...
| Boundary |
| Boundary |`| Boundary |`| Boundary |`| Boundary |
| Boundary |�| Boundary |�| Boundary |-| Boundary |e| Boundary |q| Boundary |u| Boundary |i| Boundary |v| Boundary |(| Boundary |e| Boundary |�| Boundary |�| Boundary |�| Boundary |,| Boundary | | Boundary |e| Boundary |�| Boundary |�| Boundary |�| Boundary |)| Boundary | | Boundary |�| Boundary |�| Boundary |�| Boundary | | Boundary |h| Boundary |a| Boundary |s| Boundary |h| Boundary |(| Boundary |n| Boundary |o| Boundary |r| Boundary |m| Boundary |a| Boundary |l| Boundary |i| Boundary |z| Boundary |e| Boundary |(| Boundary |e| Boundary |�| Boundary |�| Boundary |�| Boundary |)| Boundary |)| Boundary | | Boundary |=| Boundary | | Boundary |h| Boundary |a| Boundary |s| Boundary |h| Boundary |(| Boundary |n| Boundary |o| Boundary |r| Boundary |m| Boundary |a| Boundary |l| Boundary |i| Boundary |z| Boundary |e| Boundary |(| Boundary |e| Boundary |�| Boundary |�| Boundary |�| Boundary |)| Boundary |)| Boundary |
| Boundary |(| Boundary |+| Boundary | | Boundary |a| Boundary | | Boundary |b| Boundary |)| Boundary | | Boundary |�| Boundary |�| Boundary |�| Boundary |_| Boundary |h| Boundary |a| Boundary |s| Boundary |h| Boundary | | Boundary |(| Boundary |+| Boundary | | Boundary |b| Boundary | | Boundary |a| Boundary |)| Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary | | Boundary |;| Boundary | | Boundary |C| Boundary |o| Boundary |m| Boundary |m| Boundary |u| Boundary |t| Boundary |a| Boundary |t| Boundary |i| Boundary |v| Boundary |e| Boundary | | Boundary |e| Boundary |q| Boundary |u| Boundary |i| Boundary |v| Boundary |a| Boundary |l| Boundary |e| Boundary |n| Boundary |c| Boundary |e| Boundary |
| Boundary |(| Boundary |+| Boundary | | Boundary |(| Boundary |+| Boundary | | Boundary |a| Boundary | | Boundary |b| Boundary |)| Boundary | | Boundary |c| Boundary |)| Boundary | | Boundary |�| Boundary |�| Boundary |�| Boundary |_| Boundary |h| Boundary |a| Boundary |s| Boundary |h| Boundary | | Boundary |(| Boundary |+| Boundary | | Boundary |a| Boundary | | Boundary |b| Boundary | | Boundary |c| Boundary |)| Boundary | | Boundary | | Boundary | | Boundary |;| Boundary | | Boundary |A| Boundary |s| Boundary |s| Boundary |o| Boundary |c| Boundary |i| Boundary |a| Boundary |t| Boundary |i| Boundary |v| Boundary |e| Boundary | | Boundary |e| Boundary |q| Boundary |u| Boundary |i| Boundary |v| Boundary |a| Boundary |l| Boundary |e| Boundary |n| Boundary |c| Boundary |e| Boundary |
| Boundary |`| Boundary |`| Boundary |`| Boundary |
| Boundary |
...
| Boundary |-| Boundary | | Boundary |D| Boundary |e| Boundary |p| Boundary |e| Boundary |n| Boundary |d| Boundary |e| Boundary |n| Boundary |t| Boundary | | Boundary |t| Boundary |y| Boundary |p| Boundary |e| Boundary |s| Boundary | | Boundary |(| Boundary |�| Boundary |�| Boundary |,| Boundary | | Boundary |�| Boundary |�| Boundary |)| Boundary | | Boundary |f| Boundary |o| Boundary |r| Boundary | | Boundary |p| Boundary |r| Boundary |e| Boundary |c| Boundary |i| Boundary |s| Boundary |e| Boundary | | Boundary |s| Boundary |p| Boundary |e| Boundary |c| Boundary |i| Boundary |f| Boundary |i| Boundary |c| Boundary |a| Boundary |t| Boundary |i| Boundary |o| Boundary |n| Boundary |s| Boundary |
...
**File Export Discovery** (`boundary/introspect/exports.ss`):
...
The namespaced form searches base directories (`lattice/`, `core/`, `boundary/`) for the path.
...
Performance-critical paths have optional Rust acceleration via FFI, located in `boundary/ffi/rust-accel/`. This layer is designed for operations where computation significantly exceeds FFI overhead.
...
The `boundary/io/atomic.ss` module implements atomic file writes using the *write-then-rename* pattern:
...
The `boundary/io/file-lock.ss` module provides file locking for multi-step atomic operations:
...
**POSIX FFI layer** (`boundary/ffi/posix-ffi.ss`, `boundary/ffi/rust-accel/src/posix.rs`):
...
The REPL History module (`boundary/history/`) demonstrates command replay as an alternative to state serialization—a key insight for systems with opaque runtime objects.
...
**Integration**: The REPL worker (`boundary/repl/repl-worker.ss`) hooks command recording into evaluation:
...
The registry (`boundary/migrations/registry.ss`) manages migrations and computes paths:
...
The provenance module (`boundary/provenance/`) instruments optic operations to create a complete audit trail in the CAS. Every traced operation produces a provenance record capturing what happened, enabling "explain this value" queries and regulatory compliance.
...
The reactive module (`boundary/reactive/`) builds on provenance tracking to provide automatic reactivity via optic-based dependency graphs. When a derivation is computed, we track which optics were accessed. When those optics are written to, the derivation invalidates and recomputes on next access.
...
The Fold includes an LSP implementation (`boundary/lsp/`) providing:
