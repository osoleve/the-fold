...
(define (derive-category path)
  (cond
   [(string-contains? path "core/linalg") 'linalg]
   ...
   [(string-contains? path "core/data") 'data]
   [(string-contains? path "core/query") 'query]
   [(string-contains? path "core/util") 'util]
   [(string-contains? path "core/numeric") 'numeric]
   [(string-contains? path "core/autodiff") 'autodiff]
   [(string-contains? path "core/random") 'random]
   [(string-contains? path "core/pipeline") 'pipeline]
   [(string-contains? path "core/info-theory") 'info-theory]
   [(string-contains? path "core/fp/control") 'fp-control]
   [(string-contains? path "core/fp/numeric") 'fp-numeric]
   [(string-contains? path "core/fp/parsing") 'fp-parsing]
   [(string-contains? path "core/fp/meta") 'fp-meta]
   [(string-contains? path "core/fp/data") 'fp-data]
   [(string-contains? path "core/fp/game") 'fp-game]
   [(string-contains? path "core/fp/symbolic") 'fp-symbolic]
   [(string-contains? path "core/fp/measure") 'fp-measure]
   [(string-contains? path "core/fp/control-systems") 'fp-control-systems]
   [(string-contains? path "core/fp") 'fp]
   [(string-contains? path "shell") 'shell]
