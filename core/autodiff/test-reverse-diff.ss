...
(test-group gradient-tests
            ...
            (define-test gradient-three-vars
              ;; f(x,y,z) = xyz, nabla(f) at (2,3,4) = (yz, xz, xy) = (12, 8, 6)
