...
;;; conditional-entropy-direct : (List (List Number)) -> Number
...
;;; sample-entropy : (List Symbol) -> Number
...
;;; count-occurrences : (List a) -> (List (a . Int))
...
;;; update-count : a -> (List (a . Int)) -> (List (a . Int))
