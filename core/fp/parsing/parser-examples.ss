...
;;; chain-left1 : Parser a x Parser (a x a -> a) -> Parser a
...
;;; ini-section : Parser (String . Alist)
(define ini-section
...
;;; ini-file : Parser (List (String . Alist))
(define ini-file
...
;;; ini-get : INI x String x String -> Maybe String
