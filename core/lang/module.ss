...
;;; Module path registration table (extracted to module-paths.ss)
(load "core/lang/module-paths.ss")
...
;;; Module display/discovery tooling (extracted to module-display.ss)
(load "core/lang/module-display.ss")

;;; Module reloading (extracted to module-reload.ss)
(load "core/lang/module-reload.ss")
