...
for accelerating Layer 1 primitives via FFI.")
 ...
 (tests
  ((test-parse.ss "Parser combinator tests")
   ...
   (test-rust-codegen.ss "Rust codegen tests (264 tests)")))
 ...
 (rust-codegen
  ...
  (features
   ...
   (closures "R-Lambda for anonymous functions, compiles to Rust closures |x| body")
  ...
  (limitations
   (no-capture "R-Letrec generates Rust fn items which cannot capture outer scope variables")
  ...
  (future-work
   (capturing-closures "Closures that capture environment variables (defunctionalization)")
