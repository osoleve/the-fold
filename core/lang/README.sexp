...
for accelerating Layer 1 primitives via FFI.")
 ...
 (tests
  ((test-parse.ss "Parser combinator tests")
   ...
   (test-rust-codegen.ss "Rust codegen tests (259 tests)")))
 ...
 (rust-codegen
  ...
  (limitations
   ...
   (static-fuel "Fuel is computed statically; recursive calls do not consume fuel at runtime")
  ...
  (future-work
   ...
   (dynamic-fuel "Thread fuel through generated functions for bounded recursion")
