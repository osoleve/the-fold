...
'(project-tracker
  (name "Rust Migration: Chez → Kernel")
  (start-date "2025-12-26")
  (target-date "2026-01-30")
  (owner opus)

  (milestones
    ((name "M1: Kernel Foundation")
     (target "2026-01-09")
     (description "Basic Rust VM with 8 core forms"))

    ((name "M2: ANSI Scheme Layer")
     (target "2026-01-16")
     (description "R6RS/R7RS compatibility primitives"))

    ((name "M3: FoldLang Extensions")
     (target "2026-01-23")
     (description "Blocks, CAS, normalization"))

    ((name "M4: Parser & Integration")
     (target "2026-01-30")
     (description "Complete system with tests"))

    ((name "M5: Production Ready")
     (target "2026-02-06")
     (description "Performance, validation, cutover")))

  ;; ================================================================
  ;; PHASE 1: KERNEL (Week 1-2)
  ;; ================================================================

  (phase
    (name "Phase 1: Kernel Foundation")
    (milestone "M1")
    (estimate "10-15 days")
    ...
    (task
      ...
      (estimate "4 hours")
      (assignee opus)
      (depends-on "K002" "K003" "K004" "K005")
    ...
    (task
      ...
      (estimate "6 hours")
      (assignee opus)
      (depends-on "K006" "K007" "K008" "K009" "K010")
  ...
  ;; ================================================================
  ;; PHASE 2: ANSI SCHEME LAYER (Week 2)
  ;; ================================================================

  (phase
    (name "Phase 2: ANSI Scheme Primitives")
    (milestone "M2")
    (estimate "5-7 days")
    ...
    (task
      ...
      (estimate "8 hours")
      (assignee opus)
      (depends-on "A002" "A003" "A004" "A006" "A007" "A010")
      (deliverable "tests/ansi_scheme.rs with 50+ tests")
      (notes "Test against R6RS/R7RS spec")))

  ;; ================================================================
  ;; PHASE 3: FOLDLANG EXTENSIONS (Week 3)
  ;; ================================================================

  (phase
    (name "Phase 3: FoldLang Primitives")
    (milestone "M3")
    (estimate "7-10 days")
    ...
    (task
      ...
      (estimate "6 hours")
      (assignee opus)
      (depends-on "F001" "F002" "F003" "F004" "F005")
