;;; lattice/control-systems/stability.ss — Stability Analysis
;;;
...
;;; @requires prelude numeric/polynomial matrix matrix-eigen control/transfer-function control/state-space
(require 'prelude)
