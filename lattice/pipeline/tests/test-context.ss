...
(test-group "Schedule"
  ...
  (define-test "discord-mention schedule-type"
    (let ([sched (make-discord-mention-schedule 'catalyst)])
      (assert-equal 'discord-mention (schedule-type sched))))

  (define-test "discord-mention schedule-spec"
    (let ([sched (make-discord-mention-schedule 'catalyst)])
      (assert-equal 'catalyst (schedule-spec sched))))

  (define-test "discord-reaction schedule-type"
    (let ([sched (make-discord-reaction-schedule ":fire:")])
      (assert-equal 'discord-reaction (schedule-type sched))))

  (define-test "discord-keyword schedule-type"
    (let ([sched (make-discord-keyword-schedule "help")])
      (assert-equal 'discord-keyword (schedule-type sched))))
...
(test-group "Discord Context"
  ;; Test make-discord-context
  (define-test "make-discord-context creates alist"
  ...
  (define-test "discord context has message-id"
    (let* ([trigger-data '((message-id . "123")
                           (channel-id . "456")
                           (author-id . "789")
                           (author . "TestUser")
                           ...
                           (body . "Hello!"))]
           [dc (make-discord-context trigger-data)])
      (assert-equal "123" (cdr (assq 'discord-message-id dc)))))

  (define-test "discord context has channel-id"
    (let* ([trigger-data '((message-id . "123")
                           (channel-id . "456")
                           (author-id . "789")
                           (author . "TestUser")
                           ...
                           (body . "Hello!"))]
           [dc (make-discord-context trigger-data)])
      (assert-equal "456" (cdr (assq 'discord-channel-id dc)))))

  (define-test "discord context has author-id"
    (let* ([trigger-data '((message-id . "123")
                           (channel-id . "456")
                           (author-id . "789")
                           (author . "TestUser")
                           ...
                           (body . "Hello!"))]
           [dc (make-discord-context trigger-data)])
      (assert-equal "789" (cdr (assq 'discord-author-id dc)))))

  (define-test "discord context has author-name"
    (let* ([trigger-data '((message-id . "123")
                           (channel-id . "456")
                           (author-id . "789")
                           (author . "TestUser")
                           ...
                           (body . "Hello!"))]
           [dc (make-discord-context trigger-data)])
      (assert-equal "TestUser" (cdr (assq 'discord-author-name dc)))))

  (define-test "discord context has content"
    (let* ([trigger-data '((message-id . "123")
                           (channel-id . "456")
                           (author-id . "789")
                           (author . "TestUser")
                           ...
                           (body . "Hello!"))]
           [dc (make-discord-context trigger-data)])
      (assert-equal "Hello!" (cdr (assq 'discord-content dc)))))

  ;; Test ctx-with-discord
  (define-test "ctx-with-discord adds discord context"
    (let* ([trigger-data '((message-id . "msg-1"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "msg-1" (ctx-env-ref ctx 'discord-message-id))))

  ;; Test discord context accessors
  (define-test "ctx-discord-message-id"
    (let* ([trigger-data '((message-id . "m1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "m1" (ctx-discord-message-id ctx))))

  (define-test "ctx-discord-channel-id"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "c1" (ctx-discord-channel-id ctx))))

  (define-test "ctx-discord-author-id"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "a1" (ctx-discord-author-id ctx))))

  (define-test "ctx-discord-author-name"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "User1" (ctx-discord-author-name ctx))))

  (define-test "ctx-discord-guild-id"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "g1" (ctx-discord-guild-id ctx))))

  (define-test "ctx-discord-content"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-equal "Content" (ctx-discord-content ctx))))

  (define-test "ctx-is-discord-triggered? true"
    (let* ([trigger-data '((message-id . "m1")
                           (channel-id . "c1")
                           (author-id . "a1")
                           (author . "User1")
                           ...
                           (body . "Content"))]
           [ctx (ctx-with-discord empty-context trigger-data)])
      (assert-true (ctx-is-discord-triggered? ctx))))

  ;; Test non-discord context
  (define-test "ctx-discord-message-id returns #f for non-discord"
    (assert-equal #f (ctx-discord-message-id empty-context)))

  (define-test "ctx-is-discord-triggered? false for non-discord"
    (assert-equal #f (ctx-is-discord-triggered? empty-context))))
