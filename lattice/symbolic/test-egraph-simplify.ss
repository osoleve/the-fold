;;; lattice/symbolic/test-egraph-simplify.ss — Tests for E-Graph Simplification
;;;
...
;;;
;;; Run with: scheme --script lattice/symbolic/test-egraph-simplify.ss

(load "core/lang/module.ss")
(load "core/testing/test-framework.ss")
(load "lattice/symbolic/egraph-simplify.ss")
