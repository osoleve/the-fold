;;; core/fp/symbolic/test-integrate-autodiff.ss — Tests for Symbolic-Autodiff Integration
;;;
;;; Tests for eval-expr, simplify, expr-to-traced, and high-level integration.
;;;
;;; NOTE: Run from project root: scheme --script core/fp/symbolic/test-integrate-autodiff.ss
