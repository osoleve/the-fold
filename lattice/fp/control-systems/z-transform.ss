;;; lattice/fp/control-systems/z-transform.ss — Discrete Transfer Functions
;;;
...
;;;   - lattice/fp/control-systems/discrete-control.ss
...
(define (string-join strings sep)
  (if (null? strings)
      ""
      (let loop ([strs (cdr strings)] [acc (car strings)])
           (if (null? strs)
               acc
