;;; lattice/game-theory/test-mcdm.ss — Tests for Multi-Criteria Decision Making
;;; Run: scheme --script lattice/game-theory/test-mcdm.ss

(load "core/testing/test-framework.ss")
(load "lattice/game-theory/mcdm.ss")
