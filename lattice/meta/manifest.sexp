...
(skill meta
  ...
  (modules
   ...
   (unused-requires "unused-requires.ss" "Detect unused (require ...) statements via export analysis")
   (skill-map "skill-map.ss" "Module-to-skill mapping from manifest data")
   (derive-deps "derive-deps.ss" "Derive skill deps from require graph")
   (fuel-normalize "fuel-normalize.ss" "Normalize fuel-bound strings into fuel-vocab forms")))
