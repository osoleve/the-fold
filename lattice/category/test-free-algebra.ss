;;; lattice/category/test-free-algebra.ss — Free Algebra Tests
;;;
...
;;;
;;; Run from project root: scheme --script lattice/category/test-free-algebra.ss

(load "core/lang/module.ss")
(load "lattice/category/free-algebra.ss")
(load "lattice/category/monad-derivation.ss")
