;;; lattice/category/test-kleisli.ss — Kleisli Category Tests
;;;
...
;;;
;;; Run from project root: scheme --script lattice/category/test-kleisli.ss

(load "core/lang/module.ss")
(load "lattice/category/kleisli.ss")
(load "lattice/category/common-monads.ss")
