;;; lattice/category/test-logic-adjunction.ss — Tests for Logic Adjunctions
;;;
;;; Tests for:
...
;;;
;;; Run from project root: scheme --script lattice/category/test-logic-adjunction.ss

(load "core/lang/module.ss")
(load "lattice/category/logic-adjunction.ss")
