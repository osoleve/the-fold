...
(doc 'module 'test-diff-constraints3d)
(doc 'description "Tests for diff-constraints3d")
(doc 'layer 'lattice)
(doc 'note "Run with: scheme --script lattice/physics/diff3d/test-diff-constraints3d.ss")
