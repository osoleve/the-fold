...
(doc 'module 'test-smooth-collision3d)
(doc 'description "Tests for smooth-collision3d")
(doc 'layer 'lattice)
(doc 'note "Run with: scheme --script lattice/physics/diff3d/test-smooth-collision3d.ss")
