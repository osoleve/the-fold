...
(doc 'module 'test-traced-integrators3d)
(doc 'description "Tests for traced-integrators3d")
(doc 'layer 'lattice)
(doc 'note "Run with: scheme --script lattice/physics/diff3d/test-traced-integrators3d.ss")
